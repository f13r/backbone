...
(function () {
    var e, n, t, i;
    e = function (e) {
        return $("<style>").attr({"class": "keyframe-style", id: e.id, type: "text/css"}).appendTo("head")
    }, $.keyframe = {getVendorPrefix: function () {
        var e;
        return e = navigator.userAgent, -1 !== e.indexOf("Opera") ? "-o-" : -1 !== e.indexOf("MSIE") ? "-ms-" : -1 !== e.indexOf("WebKit") ? "-webkit-" : ""
    }, isSupported: function () {
        var e, n, t;
        if (n = $("body").get(0), e = !1, n.style.animationName)e = !0; else {
            t = this.getVendorPrefix().slice(1, -1);
            var i = t + "AnimationName";
            i in n.style && (e = !0)
        }
        return e
    }, generate: function (n) {
        var t, i, a, r, o, s;
        r = n.name || "", a = "@" + $.keyframe.getVendorPrefix() + "keyframes " + r + " {";
        for (s in n)if ("name" !== s) {
            a += s + " {";
            for (o in n[s])a += o + ":" + n[s][o] + ";";
            a += "}"
        }
        a = PrefixFree.prefixCSS(a + "}"), i = $("style#" + n.name), i.length > 0 ? (i.html(a), t = $("*").filter(function () {
            this.style["" + $.keyframe.getVendorPrefix().slice(1, -1) + "AnimationName"] === r
        }), t.each(function () {
            var e, n;
        ...
        if (!e.length)return this.generate(e);
        for (var n = 0; n < e.length; n++) {
            var t = e[n];
            this.generate(t)
        }
    }}, i = $.keyframe.getVendorPrefix(), n = "animation-play-state", t = "running", $.fn.resetKeyframe = function (e) {
        $(this).css(i + n, t).css(i + "animation", "none");
        e && setTimeout(e, 1)
    }, $.fn.pauseKeyframe = function () {
        $(this).css(i + n, "paused")
    }, $.fn.resumeKeyframe = function () {
        return $(this).css(i + n, t)
    }, $.fn.playKeyframe = function (e, a) {
        var r, o, s, f, m, d;
        if ("string" == typeof e) {
            var c = e.trim().split(" ");
            e = {name: c[0], duration: parseInt(c[1]), timingFunction: c[2], delay: parseInt(c[3]), repeat: c[4], direction: c[5], fillMode: c[6], complete: a}
        }
        e = $.extend({duration: 0, timingFunction: "ease", delay: 0, repeat: 1, direction: "normal", fillMode: "forwards", complete: a}, e), f = e.duration, s = e.delay, d = e.repeat, r = "" + e.name + " " + f + "ms " + e.timingFunction + " " + s + "ms " + d + " " + e.direction + " " + e.fillMode, a = e.complete, o = i + "animation", m = ["webkit", "moz", "MS", "o", ""];
        var l = function (e, n, t) {
            var i, a, r;
            for (a = 0, r = []; a < m.length;)m[a] || (n = n.toLowerCase()), i = m[a] + n, e.off(i).on(i, t), r.push(a++)
        };
        this.each(function () {
            var s = $(this).addClass("boostKeyframe").css(i + n, t).css(o, r).data("keyframeOptions", e);
            a && (l(s, "AnimationIteration", a), l(s, "AnimationEnd", a))
        })
    }, e({id: "boost-keyframe"}).append(" .boostKeyframe{" + i + "transform:scale3d(1,1,1);}")
}).call(this);
